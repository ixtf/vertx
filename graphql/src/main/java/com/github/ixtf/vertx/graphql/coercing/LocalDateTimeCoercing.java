 ...
 */
public class LocalDateTimeCoercing implements Coercing<Object, Object> {
    private static LocalDateTime convertImpl(Object o) {
        if (o instanceof LocalDateTime) {
            return (LocalDateTime) o;
        }
        if (o instanceof Date) {
            return J.localDateTime((Date) o);
        }
        if (o instanceof Number) {
            final long l = ((Number) o).longValue();
            return J.localDateTime(new Date(l));
        }
    ...
    public Object serialize(Object dataFetcherResult) throws CoercingSerializeException {
        return Optional.ofNullable(convertImpl(dataFetcherResult))
                ...
                .orElseThrow(() -> {
                    ...
                    return new CoercingSerializeException("Expected type 'LocalDateTime' but was '" + typeName + "'.");
                });
    }
