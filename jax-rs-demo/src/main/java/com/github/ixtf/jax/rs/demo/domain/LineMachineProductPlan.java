...
import com.github.ixtf.jax.rs.demo.jackson.LineMachineEmbedSerializer;
import com.github.ixtf.jax.rs.demo.jackson.ProductPlanNotifyEmbedSerializer;
...
@Entity
public class LineMachineProductPlan implements IEntityLoggable<Operator> {
    @ToString.Include
