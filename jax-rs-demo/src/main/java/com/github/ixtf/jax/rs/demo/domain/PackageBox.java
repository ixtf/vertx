...
import com.github.ixtf.jax.rs.demo.domain.data.PackageBoxType;
import com.github.ixtf.jax.rs.demo.domain.data.SaleType;
import com.github.ixtf.jax.rs.demo.domain.listener.LuceneListener;
...
@Entity
public class PackageBox implements IEntityLoggable<Operator> {
    @ToString.Include
