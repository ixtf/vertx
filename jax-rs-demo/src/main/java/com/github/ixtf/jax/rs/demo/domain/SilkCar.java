...
import com.github.ixtf.jax.rs.demo.domain.data.SilkCarSideType;
import com.github.ixtf.jax.rs.demo.domain.data.SilkCarType;
import com.github.ixtf.jax.rs.demo.dto.CheckSilkDTO;
...
@Cacheable
@Entity
public class SilkCar implements IEntityLoggable<Operator> {
    @ToString.Include
